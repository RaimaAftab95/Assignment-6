function calculateBMI() 
{
 ...
 console.log( feet);
 console.log(inches);
    //checks if any of the user input values (weight, feet, or inches) is not a valid number (e.g text or empty input fields)
    ...
    // toFixed(1) method is used to format the BMI to two decimal places, ensuring it's displayed with two digits after the decimal point.
